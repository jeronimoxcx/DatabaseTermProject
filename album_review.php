...
<html>
    ...
    <body>
        ...
        <article>
            ...
            $sql = "SELECT * FROM album_review ORDER BY a_review_num ASC";
            $result =  mysqli_query($conn, $sql);
                    ...
                    while($row = mysqli_fetch_assoc($result)){
                        ...
                        echo '<a href="/a_like_process.php?id='.$row['a_review_num'].'">'."Like".'</a>'."  ";
                        echo '<a href="/a_dislike_process.php?id='.$row['a_review_num'].'">'."Dislike".'</a>'."  ";
